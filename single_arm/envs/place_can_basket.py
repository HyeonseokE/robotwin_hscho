...
class place_can_basket(Base_Task):
    ...
    def play_once(self):
        ...
        if self.plan_success is False:
            ...
            self._skill_label_tracker.register_skill(
                skill_type="move_to_pose", arm_tag=str(self.arm_tag),
                target="adjusted pose")
            ...
            self._skill_label_tracker.register_skill(
                ...
                target_object_name="can", direction="downward")
